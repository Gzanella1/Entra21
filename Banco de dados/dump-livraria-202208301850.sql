...
INSERT INTO `dvd` VALUES (1,'George Lucas','02:01:00',1977,1),(2,'Barry Sonnenfeld','01:38:00',1997,2),(3,'Andrew Adamson, Vicky Jenson','01:29:00',2001,3),(4,'Andrew Adamson, Kelly Asbury, Conrad Vernon','01:32:00',2004,7),(5,'Irvin Kershner','02:04:00',1980,8);
...
INSERT INTO `franquia` VALUES (1,'Shrek'),(2,'Star Wars'),(3,'MIB'),(4,'Desventuras em Série');
...
INSERT INTO `genero` VALUES (1,'Sci-fi'),(2,'Ação'),(3,'Aventura'),(4,'Comédia'),(5,'Fantasia'),(6,'Romance Policial'),(7,'Suspense'),(8,'Mistério'),(9,'Ficção Absurda'),(10,'Ficção Gótica');
...
INSERT INTO `livro` VALUES (1,'Isaac Asimov',253,1950,1,4),(2,'Dan Brown',432,2004,1,5),(3,'Eduardo Spohr',586,2010,1,6),(4,'Lemony Snicket',162,1999,1,9),(5,'Lemony Snicket',180,1999,1,10);
...
-- Dump completed on 2022-08-30 18:50:11
